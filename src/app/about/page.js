  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>Currently working on <Link href='https://generaltranslation.com' target="_blank">General Translation</Link>, a company which makes AI language tools for students and developers, with <Link href='https://www.linkedin.com/in/fernando-aviles/' target="_blank">Fernando Avilés-García</Link></li>
      </ul>
      <Link href='/'>←</Link>
      </main>
    </>
